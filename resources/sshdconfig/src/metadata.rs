...
pub const SSHD_CONFIG_HEADER: &str = "# This file is managed by the Microsoft.OpenSSH.SSHD/sshd_config DSC Resource.\n# Please do not modify manually, as any changes may be overwritten.\n";
pub const SSHD_CONFIG_RESOURCE_VERSION: &str = concat!("The Microsoft.OpenSSH.SSHD/sshd_config DSC Resource version is ", env!("CARGO_PKG_VERSION"));
