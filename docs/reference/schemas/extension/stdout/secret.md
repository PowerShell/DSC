---
description: JSON schema reference for the 'secret' operation output in a DSC extension
ms.date:     09/01/2026
ms.topic:    reference
title:       DSC extension secret operation stdout schema reference
---

# DSC extension secret operation stdout schema reference
