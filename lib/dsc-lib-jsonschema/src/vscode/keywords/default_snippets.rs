...
pub struct Snippet {
    ...
    ///
    /// If you define both the `description` and `markdownDescription` proeprty for a
...
impl JsonSchema for DefaultSnippetsKeyword {
    fn json_schema(_: &mut schemars::SchemaGenerator) -> schemars::Schema {
        json_schema!({
            ...
            "description": t!("vscode.keywords.defaultSnippets.title"),
            "markdownDescription": t!("vscode.keywords.defaultSnippets.title"),
            ...
            "items": {
                ...
                "properties": {
                    "label": {
                        "title": t!("vscode.keywords.defaultSnippets.properties.label.title"),
                        "description": t!("vscode.keywords.defaultSnippets.properties.label.title"),
                        "markdownDescription": t!("vscode.keywords.defaultSnippets.properties.label.title"),
                        "type": "string"
                    },
                    "description": {
                        "title": t!("vscode.keywords.defaultSnippets.properties.description.title"),
                        "description": t!("vscode.keywords.defaultSnippets.properties.description.title"),
                        "markdownDescription": t!("vscode.keywords.defaultSnippets.properties.description.title"),
                        "type": "string"
                    },
                    "markdownDescription": {
                        "title": t!("vscode.keywords.defaultSnippets.properties.markdownDescription.title"),
                        "description": t!("vscode.keywords.defaultSnippets.properties.markdownDescription.title"),
                        "markdownDescription": t!("vscode.keywords.defaultSnippets.properties.markdownDescription.title"),
                        "type": "string"
                    },
                    "body": {
                        "title": t!("vscode.keywords.defaultSnippets.properties.body.title"),
                        "description": t!("vscode.keywords.defaultSnippets.properties.body.title"),
                        "markdownDescription": t!("vscode.keywords.defaultSnippets.properties.body.title"),
                    },
                    "bodyText": {
                        "title": t!("vscode.keywords.defaultSnippets.properties.bodyText.title"),
                        "description": t!("vscode.keywords.defaultSnippets.properties.bodyText.title"),
                        "markdownDescription": t!("vscode.keywords.defaultSnippets.properties.bodyText.title"),
                        "type": "string"
                    },
                },
            }
