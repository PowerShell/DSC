...
# Commands from PSDesiredStateConfiguration module. Only needed for Pwsh 7 and later. For powershell 5.1, we should use the DSC version in Windows
        ...
        switch ([moduleType]$cachedResourceInfo.ImplementationDetail) {
            ...
            'ClassBased' {
                try {
                    ...
                    $resource = GetTypeInstanceFromModule -modulename $cachedResourceInfo.ModuleName -classname $cachedResourceInfo.Name
